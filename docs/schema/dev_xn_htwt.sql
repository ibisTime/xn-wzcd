...
CREATE TABLE `tdq_budget_order` (
  ...
  `car_hgz_no` varchar(255) DEFAULT NULL COMMENT '合格证号',
  `car_frame_no` varchar(255) DEFAULT NULL COMMENT '车架号',
  `car_engine_no` varchar(255) DEFAULT NULL COMMENT '发动机号',
  ...
  `work_company_property` varchar(255) DEFAULT NULL COMMENT '单位性质',
  `work_belong_industry` varchar(255) DEFAULT NULL COMMENT '所属行业',
  `work_profession` varchar(255) DEFAULT NULL COMMENT '职业',
