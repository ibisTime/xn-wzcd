/*还款卡*/
DROP TABLE IF EXISTS `tht_bankcard`;
...
/* */
DROP TABLE IF EXISTS `tht_car_loan`;

CREATE TABLE `tht_car_loan` (
  `code` varchar(32) NOT NULL COMMENT '编号',
...
/*C端用户 */
DROP TABLE IF EXISTS `tht_cuser`;
...
/*Table structure for table `tsys_dict_copy` */

DROP TABLE IF EXISTS `tsys_dict_copy`;

CREATE TABLE `tsys_dict_copy` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` char(3) DEFAULT NULL,
  `parent_key` varchar(96) DEFAULT NULL,
  `dkey` varchar(96) DEFAULT NULL,
