...
CREATE TABLE `tdq_budget_order` (
  ...
  `apply_user_jour_show_income` tinytext DEFAULT NULL COMMENT '申请人流水是否体现月收入',
  `apply_user_is_print` tinytext DEFAULT NULL COMMENT '申请人是否打件',
  ...
  `gh_jour_show_income` tinytext DEFAULT NULL COMMENT '共还人流水是否体现月收入',
  `gh_is_print` tinytext DEFAULT NULL COMMENT '共还人是否打件',
  ...
  `guarantor1_jour_show_income` tinytext DEFAULT NULL COMMENT '担保人1流水是否体现月收入',
  `guarantor1_is_print` tinytext DEFAULT NULL COMMENT '担保人1是否打件',
  ...
  `guarantor2_jour_show_income` tinytext DEFAULT NULL COMMENT '担保人2流水是否体现月收入',
  `guarantor2_is_print` tinytext DEFAULT NULL COMMENT '担保人2是否打件',
  ...
  `should_back_bill_pdf` tinytext DEFAULT NULL COMMENT '付款凭证',
