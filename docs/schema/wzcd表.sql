...
CREATE TABLE `tdq_budget_order` (
  ...
  `apply_user_company_phone` varchar(32) DEFAULT NULL COMMENT '申请人就职单位电话',
  ...
  `guarant_print_datetime` datetime DEFAULT NULL COMMENT '担保打印日期',
  ...
  `force_insurance` tinytext COMMENT '交强险',
  `business_insurance` tinytext COMMENT '商业险',
...
CREATE TABLE `tdq_credit_user` (
  ...
  `court_network_results` varchar(255) DEFAULT NULL COMMENT '法院网查询结果',
...
CREATE TABLE `tdqt_repoint_detail` (
  ...
  `budget_code` varchar(32) CHARACTER SET big5 DEFAULT NULL COMMENT '预算单编号',
  ...
  `car_dealer_name` varchar(255) DEFAULT NULL COMMENT '汽车经销商名称(外单)',
...
CREATE TABLE `tstd_user` (
  ...
  `real_name` varchar(32) DEFAULT NULL COMMENT '真实姓名',
  `status` varchar(4) DEFAULT NULL COMMENT '状态',
  `sign` varchar(32) DEFAULT NULL COMMENT '标签',
  `sign_datetime` datetime DEFAULT NULL COMMENT '标记日期',
  `total_green_count` int(11) DEFAULT NULL COMMENT ' 绿名单累计逾期次数',
  `total_yellow_count` int(11) DEFAULT NULL COMMENT '黄名单累计逾期次数',
  `total_red_count` int(11) DEFAULT NULL COMMENT '红名单累计逾期次数',
  `total_black_count` int(11) DEFAULT NULL COMMENT '黑名单累计逾期次数',
