...
import com.cdkj.loan.dto.req.XN632336Req;
...
public class XN632336 extends AProcessor {
    ...
    public Object doBusiness() throws BizException {
        ...
        return replaceRepayPlanAO.queryReplaceRepayPlanPage(start, limit,
            condition);
    }
    ...
    public void doCheck(String inputparams, String operator)
        ...
        req = JsonUtil.json2Bean(inputparams, XN632336Req.class);
