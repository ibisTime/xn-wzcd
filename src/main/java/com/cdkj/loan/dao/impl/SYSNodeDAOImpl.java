...
public class SYSNodeDAOImpl extends AMybatisTemplate implements ISYSNodeDAO {
    ...
    public SYSNode select(SYSNode condition) {
        return super.select(NAMESPACE.concat("select_SYSNode"), condition,
            SYSNode.class);
    }

    @Override
    public long selectTotalCount(SYSNode condition) {
        return super.selectTotalCount(NAMESPACE.concat("select_SYSNode_count"),
            condition);
    }

    @Override
    public List<SYSNode> selectList(SYSNode condition) {
        return super.selectList(NAMESPACE.concat("select_SYSNode"), condition,
            SYSNode.class);
    }

    @Override
    public List<SYSNode> selectList(SYSNode condition, int start, int count) {
        return super.selectList(NAMESPACE.concat("select_SYSNode"), start,
            count, condition, SYSNode.class);
    }
