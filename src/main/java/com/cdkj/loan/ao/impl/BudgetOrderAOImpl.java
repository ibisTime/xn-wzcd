...
public class BudgetOrderAOImpl implements IBudgetOrderAO {
    ...
    public void editBudgetOrder(XN632120Req req) {
        ...
        if (EBudgetType.OUT.getCode().equals(req.getType())) {
        ...
        for (XN632120ReqRepointDetail req1 : list) {
            ...
            if (EUseMoneyPurpose.MORTGAGE.getCode().equals(// 应退按揭款 垫资
                ...
                if (ELoanPeriod.THREE_YEAR.getCode()
                    .equals(data.getLoanPeriods())) {
                    if (ERateType.CT.getCode().equals(data.getRateType())) {
                ...
                .equals(req1.getUseMoneyPurpose())) {// 协议外
                data1.setUseMoneyPurpose(
    ...
    public void invoiceMismatchApply(XN632230Req req) {
        ...
        budgetOrder.setPreCompanyLoanCs(budgetOrder.getCompanyLoanCs());
        budgetOrder
            .setCompanyLoanCs(StringValidater.toDouble(req.getCompanyLoanCs()));
        ...
        for (XN632230ReqChild reqChild : list) {
            ...
            if (EUseMoneyPurpose.MORTGAGE.getCode().equals(// 应退按揭款 垫资
                ...
                .equals(reqChild.getUseMoneyPurpose())) {// 协议内
                repointDetail.setUseMoneyPurpose(
                    EUseMoneyPurpose.PROTOCOL_INNER.getCode());
                if (ELoanPeriod.ONE_YEAER.getCode()
                    .equals(budgetOrder.getLoanPeriods())) {
                    if (ERateType.CT.getCode()
                        .equals(budgetOrder.getRateType())) {
                        repointDetail
                            .setBenchmarkRate(protocol.getPlatCtRate12());
                    }
                    if (ERateType.ZT.getCode()
                        .equals(budgetOrder.getRateType())) {
                        repointDetail
                            .setBenchmarkRate(protocol.getPlatZkRate12());
                    }
                }
                if (ELoanPeriod.TWO_YEAR.getCode()
                    .equals(budgetOrder.getLoanPeriods())) {
                    ...
                    if (ERateType.CT.getCode()
                        .equals(budgetOrder.getRateType())) {
                        repointDetail
                            .setBenchmarkRate(protocol.getPlatCtRate24());
                    }
                    if (ERateType.ZT.getCode()
                        .equals(budgetOrder.getRateType())) {
                        repointDetail
                            .setBenchmarkRate(protocol.getPlatZkRate24());
                    }
                ...
                if (ELoanPeriod.THREE_YEAR.getCode()
                    ...
                    if (ERateType.CT.getCode()
                        .equals(budgetOrder.getRateType())) {
                        repointDetail
                            .setBenchmarkRate(protocol.getPlatCtRate36());
                    }
                    if (ERateType.ZT.getCode()
                        .equals(budgetOrder.getRateType())) {
                        repointDetail
                            .setBenchmarkRate(protocol.getPlatZkRate36());
                    }
                }
            } else if (EUseMoneyPurpose.MORTGAGE.getCode()
                .equals(reqChild.getUseMoneyPurpose())
                    && EIsAdvanceFund.NO.getCode()
                        .equals(budgetOrder.getIsAdvanceFund())) {// 应退按揭款 不垫资
                repointDetail
                    .setMortgageAccountNo(reqChild.getMortgageAccountNo());
                repointDetail
                    .setUseMoneyPurpose(EUseMoneyPurpose.MORTGAGE.getCode());
            } else if (EUseMoneyPurpose.PROTOCOL_OUTER.getCode()
                .equals(reqChild.getUseMoneyPurpose())) {// 协议外
                repointDetail.setUseMoneyPurpose(
                    EUseMoneyPurpose.PROTOCOL_OUTER.getCode());
            }
            ...
            repointDetail.setRepointAmount(
                StringValidater.toLong(reqChild.getRepointAmount()));
    ...
    private void editForeignBudgetOrder(BudgetOrder data, XN632120Req req) {
        ...
        for (XN632120ReqRepointDetail req1 : list) {
            ...
            CreditUser user = creditUserBO.getCreditUserByCreditCode(
                data.getCreditCode(), ELoanRole.APPLY_USER);
            data1.setIdNo(user.getIdNo());
            data1.setOutCarDealerName(req1.getOutCarDealerName());
            data1.setCompanyCode(data.getCompanyCode());
            data1.setCarType(data.getCarType());
            data1.setLoanAmount(data.getLoanAmount());
            data1.setBankRate(data.getBankRate());
