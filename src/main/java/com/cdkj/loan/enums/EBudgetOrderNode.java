...
public enum EBudgetOrderNode {
    START_NODE("002_01", "填写预算单"), AREA_AUDIT("002_02", "区域总经理准入审核"), COMPANY_AUDIT(
     ...
     SEND_LOGISTICS("007_01","分公司内勤寄送银行材料"), COMPANY_COLLECTION_CHECK("007_02", "总公司内勤收件并核查"), SEND_BANK_MATERIALS(
            "007_03", "总公司内勤寄送银行材料"), BANK_COLLECTION_CHECK("007_04",
            "银行驻点收件并核查"),BANK_LOAN_COMMIT("007_05", "确认提交银行"), CONFIRM_RECEIVABLES("007_06", "确认收款"), BRANCH_PENDING_PARTS(
            "007_07", "分公司内勤寄送银行材料待补件"), HEADQUARTERS_PENDING_PARTS("007_08",
            "总公司内勤寄送银行材料待补件"),

     CAR_SEND_LOGISTICS("008_01","分公司内勤寄送银行材料"), CAR_COMPANY_COLLECTION_CHECK("008_02", "总公司内勤收件并核查"), CAR_SEND_BANK_MATERIALS(
            "008_03", "总公司内勤寄送银行材料"), CAR_BANK_COLLECTION_CHECK("008_04",
            "银行驻点收件并核查"),CAR_BANK_LOAN_COMMIT("008_05", "确认提交银行"), CAR_PLEDGE_CONFIRM("008_06", "抵押完成"), CAR_BRANCH_PENDING_PARTS(
            "008_07", "分公司内勤寄送银行材料待补件"), CAR_HEADQUARTERS_PENDING_PARTS(
            "008_08", "总公司内勤寄送银行材料待补件"),

     SENDING_CONTRACT("009_01","总公司准备并寄送合同到分公司"), FEN_COMPANY_COLLECTION_CHECK("009_02", "分公司内勤收件并核查"), FEN_CAR_SEND_LOGISTICS(
            "009_03", "分公司准备并寄送抵押材料"), HEADQUARTERS_CAR_COMPANY_COLLECTION_CHECK(
            "009_04", "总公司内勤收件并核查"), HEADQUARTERS_CAR_SEND_BANK_MATERIALS(
            "009_05", "总公司内勤寄送银行材料"), CAR_FEN_BANK_COLLECTION_CHECK("009_06",
            "银行驻点收件并核查"),CAR_FEN_BANK_LOAN_COMMIT("009_07", "确认提交银行"), CAR_FEN_PLEDGE_CONFIRM("009_08", "抵押完成"), HEADQUARTERS_SEND_CONTRACT("009_09", "总公司寄送合同待补件"), FEN_CAR_BRANCH_PENDING_PARTS(
