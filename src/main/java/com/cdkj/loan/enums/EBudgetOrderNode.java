...
public enum EBudgetOrderNode {
    ...
    SEND_LOGISTICS("007_01", "分公司内勤寄送银行材料"), HEADQUARTERS_SEND_PRINT("007_06",
            "总公司寄送打印材料"), LOAN_PRINT("007_02", "打印岗打印"), SEND_BANK_MATERIALS(
            "007_03", "总公司寄送银行材料"), BANK_LOAN_COMMIT("007_04", "确认提交银行"), CONFIRM_RECEIVABLES(
            "007_05", "确认收款"),

    FEN_SEND_LOGISTICS("008_01", "分公司内勤寄送银行材料"), CAR_HEADQUARTERS_SEND_PRINT(
            "008_06", "总公司寄送打印材料"), PLEDGE_PRINT("008_02", "打印岗打印"), CAR_SEND_BANK_MATERIALS(
