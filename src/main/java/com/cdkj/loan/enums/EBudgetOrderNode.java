...
public enum EBudgetOrderNode {
    ...
    SALESMAN_SEND_LOGISTICS("007_01A", "业务员准备并寄送银行材料给总公司"), BRANCH_SEND_LOGISTICS(
            "007_01B", "分公司内勤寄送银行材料给总公司"), HEADQUARTERS_SEND_PRINT("007_02","总公司寄送银行材料给打印岗"), 
            LOAN_PRINT("007_03", "打印岗打印"), BANK_LOAN_COLLATEPOST_COLLATE("007_04", "理件岗理件"), 
            SEND_BANK_MATERIALS("007_05", "寄件岗寄送材料给银行驻点"), BANK_LOAN_COMMIT("007_06", "确认提交银行"), 
            CONFIRM_RECEIVABLES("007_07", "财务确认收款"), BANK_LOAN_ACHIEVE("007_08", "还款中"),

    LOCAL_PRINTPOST_PRINT("008_01", "打印岗打印"), LOCAL_COLLATEPOST_COLLATE("008_02", "理件岗理件"), 
            LOCAL_SENDPOST_SEND_BANK("008_03", "寄件岗寄送材料给银行驻点"), LOCAL_SUBMIT_BANK("008_04", "提交银行"), 
            TODO_LOCAL_PLEDGE_ACHIEVE("008_05", "待提交抵押完成"), LOCAL_PLEDGE_ACHIEVE("008_06", "车辆抵押完成"),
    ...
    OUT_BANKPOINT_SEND_PARENT("009_01", "银行驻点发送抵押合同给总公司"), OUT_PARENT_SEND_BRANCH(
            ...
            OUT_COLLATEPOST_COLLATE("009_06", "理件岗理件"), OUT_SENDPOST_SEND_BANK(
