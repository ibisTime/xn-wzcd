...
public enum ERepayBizNode {
    ...
    TC_APPLY("021_01", "申请拖车"), TC_RISK_MANAGE_CHECK("021_02", "风控经理审核"), TC_RISK_MANAGE_CHECK_NO(
            ...
            "021_10", "确认放款"), TC_FK_INPUT("021_11", "录入拖车结果"), TC_TO_HANDLE("021_12","已录入待处理"),REDEEM("021_13", "已赎回"),
            SELLED("021_14", "出售"),JUDGE("021_15", "司法诉讼"), JUDGE_FOLLOW("021_16",
            "诉讼跟进"), JUDGE_RESULT_INPUT("021_17", "诉讼结果录入"), FINANCE_SURE_RECEIPT(
            "021_18", "财务确认收款"),
