...
public class BaofooClient {
     ...
     * @throws Exception
     */
    public static SimpleHttpResponse doRequest(RequestParams params)
            throws Exception {
        // 请求解密工具
        ...
        postData = String.format(postData, params.getMemberId(),
            params.getTerminalId(), params.getDataType(),
            params.getDataContent(), params.getVersion());
        HttpSendModel httpSendModel = new HttpSendModel(params.getRequestUrl()
                + "?" + postData);
