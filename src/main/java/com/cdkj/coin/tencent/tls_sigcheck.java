...
public class tls_sigcheck {
     ...
     */
    @Deprecated
    public native int tls_gen_signature_ex(String strExpire,
            String strAppid3rd, String SdkAppid, String strIdentifier,
            String dwAccountType, String strPriKey);
     ...
     * @return 0 为成功，非零为失败，使用 getErrMsg() 获取错误信息
     */
    public native int tls_gen_signature_ex2(String sdkAppid, String identifier,
            String priKey);
     ...
     * @return 0 为成功，非零为失败，使用 getErrMsg() 获取错误信息
     */
    public native int tls_gen_signature_ex2_with_expire(String sdkAppid,
            String identifier, String priKey, String expire);
     ...
     */
    @Deprecated
    public native int tls_check_signature_ex(String strJsonWithSig,
            String strPubKey, String strAccountType, String str3rd,
            String Appid, String strIdentify);
     ...
     */
    public native int tls_check_signature_ex2(String userSig, String pubKey,
