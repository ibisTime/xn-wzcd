...
public class TradeOrderAOImpl implements ITradeOrderAO {
    ...
    public String buy(String adsCode, String buyUser, BigDecimal tradePrice,
        ...
        // 计算交易手续费
        BigDecimal fee = count.multiply(ads.getFeeRate()).setScale(0, BigDecimal.ROUND_DOWN);
...
//sellUser.getRefeereLevel()
    ...
    private void handleUserAutoSetting(String tradeOrderCode, String userId, String toUserId) {
        ...
        if (this.userRelationBO.isExistUserRelation(userId, toUserId, EUserReleationType.TRUST.getCode())) {
            return;
        }
